              ...
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center mb-4">
                  <div className="bg-white/20 backdrop-blur-sm rounded-xl p-2 lg:p-3 mr-3 lg:mr-4">
                    <TrendingUp className="h-6 w-6 lg:h-10 lg:w-10" />
                  </div>
                  <span className="hidden sm:inline">Ativos Financeiros</span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center mt-4 sm:space-x-6 space-y-2 sm:space-y-0">
                  <div className="flex items-center">
                    <Building2 className="h-4 w-4 lg:h-5 lg:w-5 mr-2 text-blue-200" />
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm lg:text-base text-blue-100">Dados atualizados</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white shadow-xl rounded-2xl border border-gray-100">
          <div className="p-4 sm:p-6 lg:p-8">
            <div className="flex items-center mb-4 lg:mb-6">
              ...
              <h2 className="text-base lg:text-lg font-semibold text-gray-900">Buscar Ativos</h2>
            </div>
