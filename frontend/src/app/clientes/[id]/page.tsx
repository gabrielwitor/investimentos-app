...
import { ArrowLeft, User, Mail, Calendar, CheckCircle, XCircle, Wallet, TrendingUp, PieChart, DollarSign, Edit3 } from 'lucide-react'
    ...
    return (
      <AppLayout>
        <div className="p-6 text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Carregando detalhes do cliente...</p>
        </div>
      </AppLayout>
    )
  }
            ...
            <div>
              ...
              <dl className="space-y-3">
                <div>
                  ...
                  <dd className="text-sm text-gray-900">{cliente.nome}</dd>
                </div>
                <div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          {isLoadingAlocacoes ? (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-sm text-gray-600">Carregando portfólio...</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-purple-600">Diversificação</p>
              ...
              {/* Lista de ativos */}
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-3">Principais Investimentos</h4>
                <div className="space-y-2">
                  {alocacoes.alocacoes.slice(0, 5).map((alocacao) => (
                    <div key={alocacao.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900">{alocacao.ativo.nome}</p>
                          <p className="text-xs text-gray-500">{alocacao.ativo.codigo} • {alocacao.ativo.tipo}</p>
                        </div>
                      </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 mb-4">Nenhum investimento registrado</p>
              <Link 
                href={`/clientes/${cliente.id}/alocacoes`}
