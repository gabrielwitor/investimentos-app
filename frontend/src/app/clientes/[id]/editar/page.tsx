    ...
    return (
      <AppLayout>
        <div className="p-6 text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Carregando dados do cliente...</p>
        </div>
      </AppLayout>
    );
  }
    ...
    return (
      <AppLayout>
        <div className="text-center py-12">
          <div className="text-red-600 dark:text-red-400">Cliente não encontrado</div>
        </div>
      </AppLayout>
    );
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  id="nome"
                  {...register('nome')}
                  className="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-offset-gray-800"
